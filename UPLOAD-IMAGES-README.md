...
O servidor estará rodando em `https://93c44447ef94.ngrok-free.app/`

#### Pasta de uploads:
As imagens são salvas em: `api/uploads/`
Acessíveis via: `https://93c44447ef94.ngrok-free.app//uploads/[nome-do-arquivo]`
...
#### Configuração:
Certifique-se de que a variável `NEXT_PUBLIC_API_URL` está configurada (padrão: `https://93c44447ef94.ngrok-free.app//api`)
...
```bash
GET https://93c44447ef94.ngrok-free.app//api/posts/secao/Agrovia%20Ensina
```

### Acessar imagem
```bash
GET https://93c44447ef94.ngrok-free.app//uploads/[nome-do-arquivo]
```

### Criar post com imagens (cURL)
```bash
curl -X POST https://93c44447ef94.ngrok-free.app//api/posts \
